                                            ...
                                            <table class="table table-bordered table-hover zero-configuration">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit" onClick="popModalEdit('<?php echo e($d->id); ?>','<?php echo e($d->nama); ?>','<?php echo e($d->lat); ?>','<?php echo e($d->long); ?>')"><i class="bx bxs-edit-alt"></i></button></button>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function submitEdit(){
            ...
            if ($("#edt_form").valid()){
                $.post( "<?php echo e(route('admin.t.region.edit')); ?>", {
                    ...
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="<?php echo e(route('admin.t.region')); ?>"
                        }, 1000);
                    } else {
        ...
        function submitDelete(){
            ...
            $.post( "<?php echo e(route('admin.t.region.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
        ...
        function submitAdd(){
            ...
            add_lat = $("#lat").val()
            add_long = $("#long").val()
            $.post( "<?php echo e(route('admin.t.region.add')); ?>", { "_token": "<?php echo e(csrf_token()); ?>",
                "nama": add_nama,
                "lat" : add_lat,
                "long" : add_long
            })
