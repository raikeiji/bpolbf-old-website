...
<div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">LBFTA Edit Report</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.index')); ?>"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.lbfta.report')); ?>">Edit Report</a>
                                    </li>
            ...
            <div class="content-body">
                <form action="<?php echo e(route('admin.lbfta.report.update')); ?>" id="form_input"  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="basicInput" name="file_url" placeholder="Masukkan Sumber" value="<?php echo e($data->file_url); ?>">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
