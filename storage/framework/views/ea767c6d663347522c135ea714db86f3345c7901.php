            ...
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    ...
                    <div class="logo-header mostion">
                        <a href="<?php echo e(route('home')); ?>"><img src="images/logo-boplbf3.png" alt=""></a>
                    </div>
                    <!-- nav toggle button -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav"> 
                            <li class="has-mega-menu"> <a href="<?php echo e(route('tourism')); ?>#home"><?php echo e(__('header.home')); ?></a></li>
                            <li class="has-mega-menu"> <a href="<?php echo e(route('tourism')); ?>#profile"><?php echo e(__('header.labuanBajo')); ?></a></li>
                            <li class="has-mega-menu"> <a href="<?php echo e(route('tourism')); ?>#beyond"><?php echo e(__('header.beyond')); ?></a></li>
                            <li class="has-mega-menu"> <a href="<?php echo e(route('tourism')); ?>#attraction"><?php echo e(__('header.attraction')); ?></a></li>
                            <li class="has-mega-menu"> <a href="#Booking" class="site-button radius-no btnhover13"><?php echo e(__('header.booking')); ?></a></li>
                        </ul>
