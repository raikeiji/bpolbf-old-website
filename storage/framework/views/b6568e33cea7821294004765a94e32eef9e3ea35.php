...
LBFTA - Organization Structure/Position Profile
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">LBFTA Organization Structure/Position Profile</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.index')); ?>"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Organization Structure/Position Profile
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form Organization Structure/Position</h4>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.lbfta.org.update')); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul_id" value="<?php echo e($data->judul_id); ?>" id="basicInput" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                        ...
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Judul</label>
                                                        <input type="text" class="form-control" name="judul_en" value="<?php echo e($data->judul_en); ?>" id="basicInput" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                        ...
                                        <div class="tab-pane" id="cn" aria-labelledby="cn-tab" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Deskripsi</label>
                                                        <textarea class="form-control" name="deskripsi_cn" id="editor3" rows="3"><?php echo e($data->deskripsi_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="url" class="form-control" name="video_url" id="video_url" value="<?php echo e($data->video_url); ?>" placeholder="Masukkan Video Url">
                                                <small>Masukan Embed URL.</br>Contoh : https://www.youtube.com/embed/72y6HUgRKzw</small>
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            <fieldset class="form-group">
                                                <label for="basicInputFile">Gambar Badan Pembina</label>
                                            ...
                                            <img id="imgContainer" style="width: 300px" src="<?php echo e(asset('uploads/ProfileOrg/'.$data->image.'')); ?>">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12" style="margin-top:20px">
                                            <fieldset class="form-group">
                                                <label for="basicInputFile">Gambar SO </label>
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="img2" id="inputGroupFile02" onchange="loadFile2(event)" accept="image/*" />
                                                    <label class="custom-file-label" for="inputGroupFile02">Pilih file</label>
                                                </div>
                                            </fieldset>
                                            <img id="imgContainer2" style="width: 300px" src="<?php echo e(asset('uploads/ProfileOrg/'.$data->image_2.'')); ?>">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
