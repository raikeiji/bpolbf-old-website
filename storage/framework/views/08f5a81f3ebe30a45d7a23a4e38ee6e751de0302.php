                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Benefit & Resiko Factsheet and Data
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.inv.benefit_resiko.add')); ?>" class="btn btn-success round glow">
                                            ...
                                            <p hidden><?php echo e($i = 1); ?></p>
                                                ...
                                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo e(route('admin.inv.benefit_resiko.edit',$k->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title white" id="myModalLabel120">Delete Benefit Resiko</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
...
<?php if($status ==  1): ?>
        ...
        function submitDelete(){
            ...
            $.post( "<?php echo e(route('admin.inv.benefit_resiko.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="<?php echo e(route('admin.inv.benefit_resiko')); ?>";
                        }, 1000);
                    } else {
        ...
        function showImg(id, file){
            ...
            $('#imgContainer').attr('src', "<?php echo e(asset('uploads/InvestmentBenefit')); ?>/"+file+"");
