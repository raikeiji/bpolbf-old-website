...
<?php $__env->startSection('content'); ?>
	...
	<main>
		<section id="home" class="invest" style="background:url('<?php echo e(asset('uploads/SliderInvestment/'.$sliders[0]->file_img.'/')); ?>') top left no-repeat transparent;background-attachment: fixed">
			<h1 id="home-title"><?php echo e(__('investment.grow')); ?>

				<span class="subtitle d-none d-md-block"><?php echo e(__('investment.untap')); ?></span>
