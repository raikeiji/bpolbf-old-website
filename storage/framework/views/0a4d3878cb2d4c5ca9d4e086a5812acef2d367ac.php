...
<?php $__env->startSection('content'); ?>
  ...
  <main>
  	<section id="home" class="bop" style="background:url('<?php echo e(asset('uploads/SliderProfile/'.$sliders[0]->file_img.'/')); ?>') top left no-repeat transparent;">
  		<h1 id="home-title">LABUAN BAJO FLORES
  			<span class="subtitle" style="letter-spacing: 6px;">Flores Tourism Authority</span>
  		</h1>
		  						...
		  						<div class="card-body p-0">
				  					<div class="row news-item d-flex">
				  						...
				  						<div class="col-12 col-lg-8 p-4">
						  					...
						  					<a href="<?php echo e(url('boplbf/news/'.$new->slug.'')); ?>" class="d-inline-block timestamp mb-0">Read more &raquo;</a>
				  						</div>
				  					</div>
		  						</div>
		  					</div>
