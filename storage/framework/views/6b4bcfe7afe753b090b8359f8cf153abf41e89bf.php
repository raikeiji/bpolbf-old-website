                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">News Release
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.lbfta.news_release.add')); ?>" class="btn btn-success round glow">
                                                    ...
                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo e(route('admin.lbfta.news_release.edit',$d->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
        ...
        function popModalDelete(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type:"POST",
                        url : "<?php echo e(route('admin.lbfta.news_release.delete')); ?>",
                        data: { 
