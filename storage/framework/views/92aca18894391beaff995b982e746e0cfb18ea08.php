                ...
                <section id="basic-tabs-components">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="<?php echo e(route('admin.inv.komoditas_utama.update')); ?>" id="form_input"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="imgContainer" style="width: 100%;" src="<?php echo e(asset('uploads/InvestmentKomoditas/'.$data->image.'')); ?>">
                                </div>
