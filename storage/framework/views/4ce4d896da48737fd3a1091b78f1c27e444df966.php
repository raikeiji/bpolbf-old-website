                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.lbfta.faq.add')); ?>" class="btn btn-success round glow">
                                            ...
                                            <table class="table table-bordered table-hover zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($i); ?></td>
                                                            <td><?php echo $d->judul_id; ?></td>
                                                            <td><?php echo $d->deskripsi_id; ?></td>
                                                            <td><?php echo e($d->category); ?></td>
                                                            <td class="text-center">
                                                                <a href="<?php echo e(route('admin.lbfta.faq.edit',$d->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
        ...
        function popModalDelete(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type:"POST",
                        url : "<?php echo e(route('admin.lbfta.faq.delete')); ?>",
                        data: { 
