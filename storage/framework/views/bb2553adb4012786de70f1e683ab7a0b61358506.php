...
<div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.inv.business_insiders')); ?>">Industri & Investment Business Insiders</a>
                                    </li>
            ...
            <div class="content-body">
                <form action="<?php echo e(route('admin.inv.business_insiders.update')); ?>" id="form_input"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="judul_id" required id="basicInput"  placeholder="Masukkan Nama" value="<?php echo e($data->nama); ?>">
                                        </fieldset>
                                    </div>
...
<script src="<?php echo e(asset('admin_page/app-assets/vendors/js/pickers/pickadate/picker.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "<?php echo e(asset('uploads/InvestmentBI/'.$data->image.'')); ?>",
            zoom: 0
        }).then(function(){
