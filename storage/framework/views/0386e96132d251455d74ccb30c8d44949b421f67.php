                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.inv.sektor_industri')); ?>">Ragam Sektor Industri Factsheet and Data</a>
                                    </li>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.inv.sektor_industri.store')); ?>" id="form_input"  method="post" enctype="multipart/form-data">
