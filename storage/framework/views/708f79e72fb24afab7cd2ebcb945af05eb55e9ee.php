...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('admin_template/app-assets/images/ico/apple-icon-120.png')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_template/app-assets/vendors/css/pickers/pickadate/pickadate.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_template/app-assets/css/plugins/forms/validation/form-validation.css')); ?>">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern boxicon-layout no-card-shadow 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <?php echo $__env->make('adminpage.template.navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script src="<?php echo e(asset('admin_template/app-assets/vendors/js/pickers/pickadate/picker.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/vendors/js/pickers/pickadate/picker.date.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/vendors/js/pickers/pickadate/picker.time.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/vendors/js/pickers/pickadate/legacy.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin_template/app-assets/vendors/js/extensions/jquery.steps.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/vendors/js/forms/validation/jquery.validate.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin_template/app-assets/js/scripts/forms/validation/form-validation.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/js/scripts/pickers/dateTime/pick-a-datetime.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_template/app-assets/js/scripts/forms/select/form-select2.js')); ?>"></script>
