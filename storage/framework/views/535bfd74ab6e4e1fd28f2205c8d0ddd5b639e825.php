<?php $__env->startSection('title', 'Industri & Investment Opportunity'); ?>
<style>
#tags {
  float: left;
	...
	<div id="home" class="page-content bg-white">
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white"><?php echo e(__('investment.opportunity')); ?></h1>
                </div>
            </div>
        </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    ...
                    <div class="dlab-post-text">
                      ...
                      <div class="row">
                        <img src="<?php echo e(asset('uploads/InvestmentHN/'.$data->image.'')); ?>" alt="" class="center">
                      </div>
                      <?php endif; ?>
                    </div>
                    <div class="dlab-post-text">
