                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Informasi Visa
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.t.iv.add')); ?>" class="btn btn-success round glow">
                                            ...
                                            <table class="table table-bordered table-hover zero-configuration">
                                                ...
                                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($d->ishomepage == 1): ?>
                                                                <input id="check_<?php echo e($d->id); ?>" type="checkbox" class="" name="isActive" value="<?php echo e($d->isactive); ?>" checked onchange="submitActive('<?php echo e($d->id); ?>','<?php echo e($d->judul_id); ?>')">
                                                                <label for="isActive"> Active</label>
                                                            <?php else: ?>
                                                                <input id="check_<?php echo e($d->id); ?>" type="checkbox" class="" name="isActive" value="<?php echo e($d->isactive); ?>" onchange="submitActive('<?php echo e($d->id); ?>','<?php echo e($d->judul_id); ?>')">
                                                                <label for="isActive"> Active</label>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="<?php echo e(route('admin.t.iv.edit',$d->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function submitDelete(){
            ...
            $.post( "<?php echo e(route('admin.t.iv.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="<?php echo e(route('admin.t.iv')); ?>";
                        }, 1000);
                    } else {
        ...
        function submitActive(id, nama) {
            $(".cover-spin").fadeIn(500)
            up_nama = nama
            $.post( "<?php echo e(route('admin.t.iv.active')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": id })
                .done(function( res ) {
                    if (res==1){
                        ...
                        $("#toast-error-content").html("Gagal : Sudah ada Tourism Informasi Visa lain yang telah Active");
                        $("#toast-error").toast('show');
