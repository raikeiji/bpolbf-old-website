                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.inv.komoditas_utama.add')); ?>" class="btn btn-success round glow">
                                            ...
                                            <p hidden><?php echo e($i = 1); ?></p>
                                                ...
                                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo e(route('admin.inv.komoditas_utama.edit',$k->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
<?php if($status ==  1): ?>
        ...
        function submitDelete(){
            ...
            $.post( "<?php echo e(route('admin.inv.komoditas_utama.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="<?php echo e(route('admin.inv.komoditas_utama')); ?>";
                        }, 1000);
                    } else {
        ...
        function showImg(id, file){
            ...
            $('#imgContainer').attr('src', "<?php echo e(asset('uploads/InvestmentKomoditas')); ?>/"+file+"");
