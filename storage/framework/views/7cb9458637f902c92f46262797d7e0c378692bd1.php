                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.lbfta.report.add')); ?>" class="btn btn-success round glow">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo e($d->file_url); ?>">File</a></td>
                                                                <td class="text-center">
                                                                    <a href="<?php echo e(route('admin.lbfta.report.edit',$d->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
                                                                    <button type="button" class="btn btn-icon rounded-circle btn-danger glow" title="Delete" onClick="popModalDelete('<?php echo e($d->id); ?>','<?php echo e($d->judul_id); ?>')"><i class="bx bxs-trash"></i></button>
                                                                </td>
                                                            </tr>
        ...
        function popModalDelete(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type:"POST",
                        url : "<?php echo e(route('admin.lbfta.report.delete')); ?>",
                        data: { 
