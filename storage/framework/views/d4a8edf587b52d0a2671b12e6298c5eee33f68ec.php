...
function submitDelete(){
    ...
    $.post( "<?php echo e(route('admin.inv.kontak_invest.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
    .done(function( res ) {
        if (res==1){
            ...
            setTimeout(function(){ 
                ...
                window.location.href="<?php echo e(route('admin.inv.kontak_invest')); ?>";
            }, 1000);
        } else {
            Swal.fire(
