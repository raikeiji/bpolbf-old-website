                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.lbfta.faq')); ?>">FAQ</a>
                                    </li>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.lbfta.faq.update')); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea lass="form-control" id="editor1" name="judul_id" rows="3"><?php echo e($data->judul_id); ?></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Jawaban</label>
                                                        <textarea lass="form-control" id="editor2" name="deskripsi_id" rows="3"><?php echo e($data->deskripsi_id); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Pertanyaan</label>
                                                        <textarea lass="form-control" id="editor3" name="judul_en" rows="3"><?php echo e($data->judul_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Jawaban</label>
                                                        <textarea lass="form-control" id="editor4" name="deskripsi_en" rows="3"><?php echo e($data->deskripsi_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="cn" aria-labelledby="cn-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Pertanyaan</label>
                                                        <textarea lass="form-control" id="editor5" name="judul_cn" rows="3"><?php echo e($data->judul_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Jawaban</label>
                                                        <textarea lass="form-control" id="editor6" name="deskripsi_cn" rows="3"><?php echo e($data->deskripsi_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $("#category").val("<?php echo e($data->category); ?>");
