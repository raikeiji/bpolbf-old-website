                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.t.slider.add')); ?>" class="btn btn-success round glow">
                                            ...
                                            <table class="table table-bordered table-hover zero-configuration">
                                                ...
                                                <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?php echo e(route('admin.t.slider.edit',$s->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function submitDelete(){
            ...
            $.post( "<?php echo e(route('admin.t.slider.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="<?php echo e(route('admin.t.slider')); ?>";
                        }, 1000);
                    } else {
        ...
        function submitActive(id,nama) {
            $(".cover-spin").fadeIn(500)
            up_nama = nama
            $.post( "<?php echo e(route('admin.t.slider.active')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": id })
                .done(function( res ) {
                    if (res==1){
        ...
        function showImg(id, file){
            ...
            $('#imgContainer').attr('src', "<?php echo e(asset('uploads/SliderTourism')); ?>/"+file+"");
