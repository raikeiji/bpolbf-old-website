<?php $__env->startSection('title', 'BOPLBF - Culinary'); ?>
		...
		<div class="dlab-bnr-inr overlay-black-dark banner-content " style="background-image:url('<?php echo e(asset('images/pulau_padar.jpg')); ?>');">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white"><?php echo e(__('tourism.culinary')); ?></h1>
					<!-- Breadcrumb row -->
					<!-- Breadcrumb row END -->
                </div>
            </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    <div class="dlab-post-title">
                        <h1 class="post-title m-b0" style="margin-bottom: 0px;"><a href="javascript:void(0);"><?php echo $culinary->judul; ?></a></h1>
                    </div>
					...
					<div class="dlab-post-text">
                        <?php if(!empty($resto)): ?>
						<h2><?php echo e(__('tourism.resto')); ?></h2>
                   
                        <div class="list-toko">
                            <div class="row">
                                <?php $__currentLoopData = $resto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="padding-top:15px">
                                    <div class="list-toko_item">
                                        <div class="list-toko_item__header">
                                            <div class="title"><?php echo $resto->nama; ?></div>
                                        </div>
                                        <div class="list-toko_item__body">
                                            <div class="address"><?php echo $resto->alamat; ?></div>
                                            <div class="open-hour"><i class="ti-alarm-clock"></i> <?php echo $resto->jam_buka; ?></div>
                                            <div class="phone"><i class="fa fa-phone"></i><?php echo $resto->telepon; ?></div>
                                            <div class="link"><a href="<?php echo e(url('tourism/resto/'.$resto->id.'')); ?>" class="detail-link">DETAIL</a></div>
                                        </div>
                                    </div>
                                </div>
											...
											<div class="mfp-gallery">
												<div class="dlab-box">
													<div class="dlab-thum-bx dlab-img-overlay1 ">
														<img src="<?php echo e(asset('uploads/TourismCulinary/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')); ?>" alt="">
														<div class="overlay-bx">
															<div class="overlay-icon">
																<span data-exthumbimage="<?php echo e(asset('uploads/TourismCulinary/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')); ?>" data-src="<?php echo e(asset('uploads/TourismCulinary/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')); ?>" class="check-km" title="">		
						...
						<h2><?php echo e(__('tourism.recommendation')); ?> <?php echo e(__('tourism.culinary')); ?></h2>
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-sm-6 m-b30" >
										<div class="dlab-box" style="height: 100%">
                                            ...
                                            <a><img alt="" style="height: 100%" src="<?php echo e(asset('uploads/TourismCulinary/'.$r->id.'/'.$r->thumbnail.'')); ?>" ></a> 
												<div class="dlab-info-has p-a20 no-hover">
													<div class="dlab-post-title" >
														<h4 class="post-title"><a href="<?php echo e(url('tourism/culinary/'.$r->slug.'')); ?>"><?php echo $r->judul; ?></a></h4>
													</div>
												</div>
											</div>
										</div>
