...
<div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.lbfta.program')); ?>">Edit Program</a>
                                    </li>
            ...
            <div class="content-body">
                <form action="<?php echo e(route('admin.lbfta.program.update')); ?>" id="form_input"  method="post" enctype="multipart/form-data">
                    ...
                    <section id="basic-tabs-components">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <input type="text" name="id" readonly value="<?php echo e($data->id); ?>" style="display:none"/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea class="form-control"  id="editor1" name="deskripsi_id" required rows="3"><?php echo e($data->deskripsi_id); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Judul <span class="text-red"></span></label>
                                                        <input type="text" class="form-control" name="judul_en" required id="basicInput" placeholder="Masukkan Judul" value="<?php echo e($data->judul_en); ?>">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Deskripsi <span class="text-red"></span></label>
                                                        <textarea class="form-control" id="editor2" name="deskripsi_en" required rows="3"><?php echo e($data->deskripsi_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <div id='icon-picker' role="iconpicker" data-icon="<?php echo e($data->icon); ?>" data-iconset="glyphicon|ionicon|fontawesome4|fontawesome5|weathericon|mapicon|octicon|typicon|elusiveicon|flagicon"></div>
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12 form-group file-repeater">
                                            ...
                                            <div data-repeater-list="repeater">
                                                <?php $__currentLoopData = $sub_program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div id="program_<?php echo e($value->id); ?>" class="row mb-2">
                                                        <div class="col-10 col-lg-8 mb-1" style="padding:0px">
                                                            <div class="col-md-12">
                                                                <fieldset class="form-group">
                                                                    <label for="basicInput">Judul Program<span class="text-red"></span></label>
                                                                    <input type="text" class="form-control" name="judul_program[]" required  placeholder="Masukkan Judul" value="<?php echo e($value->judul); ?>">
                                                                </fieldset>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <fieldset class="form-group">
                                                                    <label for="basicInput">Deskripsi Program<span class="text-red"></span></label>
                                                                    <textarea class="form-control desc-tiny"  name="deskripsi_program[]" required rows="3"><?php echo e($value->deskripsi); ?></textarea>
                                                                </fieldset>
                                                            </div>
                                                        </div>
                                                        <div class="col-2 col-lg-4 text-lg-right" style="margin-top:25px">
                                                            <button class="btn btn-icon btn-danger trigger_delete" type="button" data-repeater-delete onclick="remove_program('<?php echo e($value->id); ?>')">
                                                                <i class="bx bx-x"></i>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        $('.timeseconds').daterangepicker({
            ...
            startDate:new Date('<?php echo e($data->tanggal); ?>'),
            locale: {
                format: 'MM-DD-YYYY'
            }
        });

        $("#icon_hide").val("<?php echo e($data->icon); ?>");
