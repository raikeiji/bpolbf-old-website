...
<header>
    ...
    <div class="navbar navbar-expand-md navbar-light bg-light home-nav home-nav-transparent">
        ...
        <ul class="navbar-nav ml-auto mb-2 mb-md-0">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('boplbf')); ?>"><?php echo e(__('header.home')); ?></a>
            </li>
            <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="nav-profile" data-toggle="dropdown" aria-expanded="false"><?php echo e(__('header.profile')); ?></a>
                <ul class="dropdown-menu" aria-labelledby="nav-profile">
                    <li><a class="dropdown-item" href="<?php echo e(route('boplbf.about')); ?>"><?php echo e(__('header.about')); ?></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('boplbf.mission')); ?>"><?php echo e(__('header.mission')); ?></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('boplbf.organization')); ?>"><?php echo e(__('header.organization')); ?></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('boplbf.respective')); ?>"><?php echo e(__('header.respective')); ?></a></li>
                </ul>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('boplbf.program')); ?>"><?php echo e(__('header.program')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('boplbf.officials')); ?>"><?php echo e(__('header.official')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('boplbf.news')); ?>"><?php echo e(__('header.news')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('boplbf.faq')); ?>"><?php echo e(__('header.faq')); ?></a>
            </li>
            <li class="nav-item">
