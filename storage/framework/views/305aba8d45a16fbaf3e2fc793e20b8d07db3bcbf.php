<?php $__env->startSection('title', 'BOPLBF - Rumah Produksi'); ?>
		...
		<div class="dlab-bnr-inr overlay-black-dark banner-content " style="background-image:url('<?php echo e(asset('images/pulau_padar.jpg')); ?>');">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white"><?php echo e(__('tourism.rumahProduksi')); ?></h1>
					<!-- Breadcrumb row -->
					<!-- Breadcrumb row END -->
                </div>
            </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    <div class="dlab-post-title">
                        <h1 class="post-title m-b0" style="margin-bottom: 0px;"><a href="javascript:void(0);"><?php echo $rumah_produksi->nama; ?></a></h1>
                    </div>
                    ...
                    <div class="dlab-post-text">
                        <?php echo $rumah_produksi->deskripsi; ?>
									...
									<div class="col-lg-4 col-md-4 col-sm-12 m-b30">
										<div class="icon-bx-wraper bx-style-1 p-a20 radius-sm br-col-w1">
											<div class="icon-content">
												...
												<p class="op7"><?php echo e($rumah_produksi->alamat); ?></p>
											</div>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-12 m-b30">
										<div class="icon-bx-wraper bx-style-1 p-a20 radius-sm br-col-w1">
											<div class="icon-content">
												...
												<p class="m-b0 op7"><?php echo e($rumah_produksi->jam_buka); ?></p>
									...
									<div class="col-lg-4 col-md-4 col-sm-12 m-b30">
										<div class="icon-bx-wraper bx-style-1 p-a20 radius-sm br-col-w1">
											<div class="icon-content">
												...
												<p class="m-b0 op7"><?php echo e($rumah_produksi->telepon); ?></p>
