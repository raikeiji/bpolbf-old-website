...
<div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.lbfta.news_release')); ?>">News Edit Release</a>
                                    </li>
            ...
            <div class="content-body">
                <form action="<?php echo e(route('admin.lbfta.news_release.update')); ?>" id="form_input"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="editor3" name="deskripsi_cn" rows="3"><?php echo e($data->judul_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="basicInput" name="author" placeholder="Masukkan Sumber" value="<?php echo e($data->author); ?>">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                            ...
                                            <fieldset class="form-group">
                                                <div id="tags">
                                                    <?php
                                                        $i=0;
                                                    ?>
                                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <input id="s_tag_<?php echo e($i); ?>" type="text" value="<?php echo e($value->tag); ?>" name="tag[]" placeholder="Tambahkan Tag" style="display:none"/>
                                                    <span id="tag_<?php echo e($i); ?>" class="tag"><?php echo e($value->tag); ?></span>
                                                    <?php
                                                        $i=$i+1;
                                                    ?>
...
<script src="<?php echo e(asset('admin_page/app-assets/vendors/js/pickers/pickadate/picker.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "<?php echo e(asset('uploads/ProfileNews/'.$data->image.'')); ?>",
            zoom: 0
        }).then(function(){
