<header>
    ...
    <div class="navbar navbar-expand-md navbar-light bg-light home-nav home-nav-transparent">
        <div class="container">
            ...
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand d-flex align-items-center">
                <img src="<?php echo e(asset('assets/img/logo1.png')); ?>" class="nav-logo" alt="Logo" height="80">
            </a>
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand d-flex align-items-center">
                <img src="<?php echo e(asset('assets/img/logo2.svg')); ?>" class="nav-logo" alt="Logo" height="80">
            </a>
        ...
        <ul class="navbar-nav ml-auto mb-2 mb-md-0">
            <li class="nav-item">
            <a class="nav-link" aria-current="page" href="<?php echo e(route('t.d.see')); ?>"><?php echo e(__('header.to_go')); ?></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('t.d.do')); ?>"><?php echo e(__('header.to_do')); ?></a>
            </li>
            <li class="nav-item">
