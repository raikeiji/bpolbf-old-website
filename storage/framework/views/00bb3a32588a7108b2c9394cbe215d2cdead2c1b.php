<?php $__env->startSection('title', 'BOPLBF - Contact Us'); ?>
      ...
      <section class="content" id="articles">
        <div class="container">
          <div class="text-center mb-5">
            <h2 class="mb-12"><?php echo e(__('profile.contact_us')); ?></h2>
                ...
                <div class="card-body">
                  <form id="contact_form">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="name" name="name"  placeholder="<?php echo e(__('profile.formName')); ?>" aria-describedby="form-contact-name">
                    </div>
                    <div class="mb-4">
                      <label for="contact-email" class="form-label sr-only">Email</label>
                      <input type="email" class="form-control" id="email" name="email" placeholder="<?php echo e(__('profile.formEmail')); ?>" aria-describedby="form-contact-email">
                      <div id="form-contact-email" class="form-text text-muted"><?php echo e(__('profile.email_not')); ?></div>
                    </div>
                    <div class="mb-4">
                      <label for="contact-name" class="form-label sr-only">Subject</label>
                      <input type="text" class="form-control form-control-lg" id="subject" name="subject" placeholder="<?php echo e(__('profile.formTitle')); ?>"  aria-describedby="form-contact-subject">
                    </div>
                    <div class="mb-4">
                      <label for="contact-message" class="form-label sr-only">Name</label>
                      <textarea id="message" name="message" cols="30" rows="3" placeholder="<?php echo e(__('profile.formMessage')); ?>" class="form-control" ></textarea>
                    </div>
