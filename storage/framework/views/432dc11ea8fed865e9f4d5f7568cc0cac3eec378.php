            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        ...
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Tourism Rumah Produksi</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.index')); ?>"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.t.rumah')); ?>">Rumah Produksi</a>
                                    </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form Add Rumah Produksi</h4>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.t.rumah.store')); ?>" id="form_input" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="form-group">
                                            <label for="basicInput">Nama Rumah Produksi<span class="text-red"></span></label>
                                            <input type="text" class="form-control" name="nama" required id="basicInput"  placeholder="Masukkan Nama Resto">
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="tel" class="form-control" name="telepon" id="kontak" placeholder="Masukkan Kontak">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
