                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.lbfta.slider')); ?>">Slider Homepage</a>
                                    </li>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.lbfta.slider.update')); ?>"  method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="row">
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="basicInput" required name="judul_id" placeholder="Masukan Judul" value="<?php echo e($data->judul_id); ?>">
                                                </fieldset>
                                            </div>
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    <label for="basicInput">Deskripsi </label>
                                                    <textarea data-length=200 class="form-control char-textarea" name="deskripsi_id" maxlength="200" id="textarea-counter" rows="3" placeholder="Deskripsi"><?php echo e($data->deskripsi_id); ?></textarea>
                                                </fieldset>
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="basicInput" name="judul_en" placeholder="Slider Title" value="<?php echo e($data->judul_en); ?>">
                                                </fieldset>
                                            </div>
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    <label for="basicInput">Description</label>
                                                    <textarea data-length=200 class="form-control char-textarea" name="deskripsi_en" maxlength="200" id="textarea-counter" rows="3" placeholder="Slider Description"><?php echo e($data->deskripsi_en); ?></textarea>
                                                </fieldset>
                                                <small class="counter-value float-right"><span class="char-count">0</span> / 200 </small>
                                            </div>
                                        </div>
                                ...
                                <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                    <div class="col-sm-12 col-lg-12 col-md-12">
                                        <fieldset class="form-group">
                                            ...
                                            <button type="button" class="btn btn-outline-primary mr-1 mb-1" data-toggle="modal" data-target="#modal_imgShow"><?php echo e($data->file_img); ?></button>
                                        </fieldset>
                                        <fieldset class="form-group">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="imgContainer" style="width: 100%;" src="<?php echo e(asset('uploads/SliderProfile/'.$data->file_img.'')); ?>">
                                </div>
