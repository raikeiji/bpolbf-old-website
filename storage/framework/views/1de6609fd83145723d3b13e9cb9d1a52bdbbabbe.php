                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.inv.hn')); ?>">Investment Opportunity</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.inv.hn.update')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            ...
                                            <img id="imgContainer" style="width: 300px" src="<?php echo e(asset('uploads/InvestmentHN/'.$data->image.'')); ?>">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
