                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.t.elb.art')); ?>">Enchanting Labuan Bajo Art & Craft</a>
                                    </li>
                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form id="form_input" action="<?php echo e(route('admin.t.elb.art.update')); ?>"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul_id" required id="judul_id" value="<?php echo e($data->judul_id); ?>" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                        ...
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Judul <span class="text-red">*</span></label>
                                                        <input type="text" class="form-control" name="judul_en" id="basicInput" value="<?php echo e($data->judul_en); ?>" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="URL" id="url" value="<?php echo e($data->video_url); ?>"  placeholder="Masukkan URL Video">
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="toko[]" id="Select" multiple="multiple" class="select2 form-control" data-placeholder="Pilih Toko">
                                                    <?php $__currentLoopData = $toko; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo e($status = 0); ?>

                                                        <?php $__currentLoopData = $relasiToko; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rto => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($value->id == $v->id_toko): ?>
                                                                <?php echo e($status = 1); ?>
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr id="gallery_<?php echo e($gallery->id); ?>">
                                                        <th><img src="<?php echo e(asset('uploads/TourismArtCraft/ELB/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')); ?>" alt="" width="150px"></th>
                                                        <th>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "<?php echo e(asset('uploads/TourismArtCraft/ELB/'.$data->id.'/'.$data->thumbnail.'')); ?>",
            zoom: 0
        }).then(function(){
