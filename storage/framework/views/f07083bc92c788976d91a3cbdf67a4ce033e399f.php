        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                ...
                <li class=" navigation-header"><span>Tourism</span></li>
                    ...
                    <li class="<?php echo e(Request::is('admin-page/tourism/plan-your-trip') || Request::is('admin-page/tourism/plan-your-trip/*') ? 'active' : ''); ?> nav-item">
                        <a href="<?php echo e(route('admin.t.plan')); ?>">
                            <i class="bx bx-directions"></i><span class="menu-title">Rencanakan Perjalananmu</span>
                        </a>
                    </li>

                    <li class="<?php echo e(Request::is('admin-page/tourism/recomendation') || Request::is('admin-page/tourism/recomendation/*') ? 'active' : ''); ?> nav-item">
                        <a href="<?php echo e(route('admin.t.recomendation')); ?>">
