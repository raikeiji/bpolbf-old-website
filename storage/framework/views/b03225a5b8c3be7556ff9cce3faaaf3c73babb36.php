               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.lbfta.mission_vision.update')); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="vision_id" id="editor1" rows="3"><?php echo e($data->vision_id); ?></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Mission</label>
                                                        <textarea class="form-control" name="mission_id" id="editor2" rows="3"><?php echo e($data->mission_id); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Vision</label>
                                                        <textarea class="form-control" name="vision_en" id="editor3" rows="3"><?php echo e($data->vision_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Mission</label>
                                                        <textarea class="form-control" name="mission_en" id="editor4" rows="3"><?php echo e($data->mission_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="cn" aria-labelledby="cn-tab" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Vision</label>
                                                        <textarea class="form-control" name="vision_cn" id="editor5" rows="3"><?php echo e($data->vision_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Mission</label>
                                                        <textarea class="form-control" name="mission_cn" id="editor6" rows="3"><?php echo e($data->mission_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="inputGroupFile01"><?php echo e($data->image); ?></label>
                                                </div>
                                            </fieldset>
                                        </div>
                                        -->
