...
How To Invest - Industri & Investment
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Industri & Investment - How To Invest</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.index')); ?>"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.inv.how_to_invest')); ?>">Industri & Investment - How To Invest</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form How To Invest</h4>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.inv.how_to_invest.update')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            ...
                                            <img id="imgContainer" style="width: 300px" src="<?php echo e(asset('uploads/InvestmentHTI/'.$data->image.'')); ?>">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
