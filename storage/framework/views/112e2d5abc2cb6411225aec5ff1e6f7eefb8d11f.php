...
Industri & Investment - Ragam Sektor Industri Factsheet and Data
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Ragam Sektor Industri Factsheet and Data</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.index')); ?>"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Ragam Sektor Industri Factsheet and Data
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="<?php echo e(route('admin.inv.sektor_industri.add')); ?>" class="btn btn-success round glow">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <p hidden><?php echo e($i = 1); ?></p>
                                                ...
                                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($i); ?></td>
                                                            <td><?php echo e($k->judul_id); ?></td>
                                                            <td><?php echo e($k->deskripsi_id); ?></td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-icon rounded-circle btn-success glow mr-1 mb-1"  title="View Image" onClick="showImg('<?php echo e($k->id); ?>', '<?php echo e($k->image); ?>')" ><i class="bx bx-camera"></i></button>
                                                            </td>
                                                           
                                                            <td class="text-center">
                                                                <a href="<?php echo e(route('admin.inv.sektor_industri.edit',$k->id)); ?>"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
                                                                <button type="button" class="btn btn-icon rounded-circle btn-danger glow mr-1 mb-1" title="Delete" onClick="popModalDelete('<?php echo e($k->id); ?>','<?php echo e($k->judul_id); ?>')"><i class="bx bxs-trash"></i></button>
                                                            </td>
                                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title white" id="myModalLabel120">Delete Sektor Industri</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
...
<?php if($status ==  1): ?>
        ...
        function submitDelete(){
            ...
            $.post( "<?php echo e(route('admin.inv.sektor_industri.delete')); ?>", { "_token": "<?php echo e(csrf_token()); ?>", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="<?php echo e(route('admin.inv.sektor_industri')); ?>";
                        }, 1000);
                    } else {
        ...
        function showImg(id, file){
            ...
            $('#imgContainer').attr('src', "<?php echo e(asset('uploads/InvestmentSektor')); ?>/"+file+"");
