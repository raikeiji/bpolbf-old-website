                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.t.slider')); ?>">Slider Homepage</a>
                                    </li>
                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.t.slider.update')); ?>"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="basicInput" value="<?php echo e($data->judul_id); ?>" required name="judul_id" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="basicInput" value="<?php echo e($data->judul_en); ?>" name="judul_en" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                        ...
                                        <div class="tab-pane" id="cn" aria-labelledby="cn-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Judul</label>
                                                        <input type="text" class="form-control" id="basicInput" name="judul_cn" value="<?php echo e($data->judul_cn); ?>" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="imgContainer" style="width: 100%;" src="<?php echo e(asset('uploads/SliderTourism/'.$data->file_img.'')); ?>">
                                </div>
