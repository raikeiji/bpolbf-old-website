...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('admin_template/app-assets/images/ico/favicon.ico')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_template/app-assets/css/pages/authentication.css')); ?>">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication mb-0">
                            <div class="row m-0">
                                            ...
                                            <div class="card-body">
                                                <?php if($errors->has('email')): ?>
                                                    <div class="alert alert-danger">
                                                        ...
                                                        <strong>Error!</strong> <?php echo e($errors->first('username') ?: $errors->first('email')); ?>
                                                ...
                                                <form action="<?php echo e(route('login')); ?>" method="POST">
                                                    ...
                                                    <div class="form-group mb-50">
                                                        ...
                                                        <input type="text" class="form-control" name="email" id="exampleInputEmail1" placeholder="Username" value="<?php echo e(old('email')); ?>"></div>
                                ...
                                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                    <div class="card-content">
                                        <img class="img-fluid" src="<?php echo e(asset('admin_template/app-assets/images/pages/login.png')); ?>" alt="branding logo">
                                    </div>
                                </div>
                            </div>
                        </div>
