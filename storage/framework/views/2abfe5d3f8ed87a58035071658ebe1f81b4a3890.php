                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.t.elb.art')); ?>">Beyond Labuan Bajo Art & Craft</a>
                                    </li>
                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.t.blb.art.update')); ?>" id="form_input" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Judul <span class="text-red">*</span></label>
                                                        <input type="text" class="form-control" id="basicInput" name="judul_en" value="<?php echo e($data->judul_en); ?>" required placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Deskripsi <span class="text-red">*</span></label>
                                                        <textarea class="form-control" name="deskripsi_en" required id="editor2" rows="3">&nbsp; <?php echo e($data->deskripsi_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <select id="toko" name="toko[]" id="Select" multiple="multiple" required class="select2 form-control" data-placeholder="Pilih Toko">
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr id="gallery_<?php echo e($gallery->id); ?>">
                                                        <th><img src="<?php echo e(asset('uploads/TourismArtCraft/BLB/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')); ?>" alt="" width="150px"></th>
                                                        <th>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "<?php echo e(asset('uploads/TourismArtCraft/BLB/'.$data->id.'/'.$data->thumbnail.'')); ?>",
            zoom: 0
        }).then(function(){
