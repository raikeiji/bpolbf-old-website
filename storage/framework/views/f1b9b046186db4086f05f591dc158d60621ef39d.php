                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.t.blb.destinasi')); ?>">Beyond Labuan Bajo Destinasi</a>
                                    </li>
                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.t.blb.destinasi.update')); ?>"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul_id" value="<?php echo e($data->judul_id); ?>" id="basicInput" placeholder="Masukkan Judul" required>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="panduan_perjalanan_id" id="editor4"  rows="3">&nbsp;<?php echo e($data->panduan_perjalanan_id); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Panduan Perjalanan <span class="text-red">*</span></label>
                                                        <textarea class="form-control" name="panduan_perjalanan_en" id="editor5"  rows="3">&nbsp;<?php echo e($data->panduan_perjalanan_en); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="panduan_perjalanan_cn" id="editor6"  rows="3">&nbsp;<?php echo e($data->panduan_perjalanan_cn); ?></textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kontak" id="kontak" value="<?php echo e($data->nomor_telepon); ?>" placeholder="Masukkan Kontak">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                <label for="basicInput">Alamat <span class="text-red">*</span></label>
                                                <input type="text" class="form-control" name="alamat" value="<?php echo e($data->alamat); ?>" id="basicInput" placeholder="Masukkan Alamat">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                <label for="basicInput">Waktu Buka <span class="text-red">*</span></label>
                                                <input type="text" class="form-control" name="jam_buka" value="<?php echo e($data->jam_buka); ?>" id="basicInput" placeholder="Masukkan Jam Buka">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                <label for="basicInput">Email <span class="text-red">*</span></label>
                                                <input type="email" class="form-control" name="email" id="basicInput" value="<?php echo e($data->email); ?>" placeholder="email">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select class="select2 form-control" multiple="multiple" name="subkategori[]" data-placeholder="Pilih Sub Kategori">
                                                    <?php $__currentLoopData = $subkategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php $__currentLoopData = $relasi_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($value->id == $v->id_sub): ?>
                                                                <?php echo e($status = 1); ?>
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="url_repuso" id="basicInput" placeholder="Masukkan URL Video" value="<?php echo e($data->url_repuso); ?>">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr id="gallery_<?php echo e($gallery->id); ?>">
                                                        <th><img src="<?php echo e(asset('uploads/TourismDestinasi/BLB/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')); ?>" alt="" width="150px"></th>
                                                        <th>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "<?php echo e(asset('uploads/TourismDestinasi/BLB/'.$data->id.'/'.$data->thumbnail.'')); ?>",
            zoom: 0
        }).then(function(){
