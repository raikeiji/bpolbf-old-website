...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('images/favicon-bajo2.png') }}">
...
<!-- Vendors -->
<link rel="stylesheet" href="{{asset('vendors/glide/css/glide.core.min.css')}}">
<link rel="stylesheet" href="{{asset('vendors/glide/css/glide.theme.min.css')}}">
...
<link class="skin" rel="stylesheet" type="text/css" href="{{asset('css/skin/skin-11.min.css')}}">
