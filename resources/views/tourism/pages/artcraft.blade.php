...
@section('title', 'BOPLBF - Art & Craft')
		...
		<div class="dlab-bnr-inr overlay-black-dark banner-content " style="background-image:url('{{asset('images/pulau_padar.jpg')}}');">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">{{ __('tourism.art') }}</h1>
					<!-- Breadcrumb row -->
					<!-- Breadcrumb row END -->
                </div>
            </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    <div class="dlab-post-title">
                        <h1 class="post-title m-b0" style="margin-bottom: 0px;"><a href="javascript:void(0);">{!! $art->judul !!}</a></h1>
                    </div>
					...
					<div class="dlab-post-text">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="padding-top:15px">
                                    <div class="list-toko_item">
                                        ...
                                        <div class="list-toko_item__body">
                                            <div class="address">{!! $toko->alamat !!}</div>
                                            <div class="open-hour"><i class="ti-alarm-clock"></i> {!! $toko->jam_buka !!}</div>
                                            <div class="phone"><i class="fa fa-phone"></i>{!! $toko->telepon !!}</div>
                                            <div class="link"><a href="{{url('tourism/rumahproduksi/'.$toko->id.'')}}" class="detail-link">DETAIL</a></div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
											...
											<div class="mfp-gallery">
												<div class="dlab-box">
													<div class="dlab-thum-bx dlab-img-overlay1 ">
														<img src="{{asset('uploads/TourismArtCraft/'.$tipe.'/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" alt="">
														<div class="overlay-bx">
															<div class="overlay-icon">
																<span data-exthumbimage="{{asset('uploads/TourismArtCraft/'.$tipe.'/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" data-src="{{asset('uploads/TourismArtCraft/'.$tipe.'/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" class="check-km" title="">		
						...
						<h2>{{ __('tourism.recommendation') }} {{ __('tourism.art') }}</h2>
									...
									<div class="col-lg-4 col-md-6 col-sm-6 m-b30" >
										<div class="dlab-box" style="height: 100%">
											<div class="dlab-media dlab-img-effect dlab-img-overlay1 no-hover" style="height: 100%"> 
                                                @if($r->kategori == "labuan")
                                                    <a href="{{url('tourism/artcraft/'.$r->slug.'')}}"><img alt="" src="{{asset('uploads/TourismArtCraft/ELB/'.$r->id.'/'.$r->thumbnail.'')}}" style="height: 100%"></a> 
                                                @else
                                                    <a href="{{url('tourism/artcraft/'.$r->slug.'')}}"><img alt="" src="{{asset('uploads/TourismArtCraft/BLB/'.$r->id.'/'.$r->thumbnail.'')}}" style="height: 100%"></a> 
                                                @endif
												<div class="dlab-info-has p-a20 no-hover">
													<div class="dlab-post-title" >
														<h4 class="post-title"><a href="{{url('tourism/artcraft/'.$r->slug.'')}}">
																{!! $r->judul !!} </a></h4>
													</div>
												</div>
											</div>
