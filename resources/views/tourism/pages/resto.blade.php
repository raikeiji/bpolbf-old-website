...
@section('title', 'BOPLBF - Restaurant')
		...
		<div class="dlab-bnr-inr overlay-black-dark banner-content " style="background-image:url('{{asset('images/pulau_padar.jpg')}}');">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">{{ __('tourism.restaurant') }}</h1>
					<!-- Breadcrumb row -->
					<!-- Breadcrumb row END -->
                </div>
            </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    <div class="dlab-post-title">
                        <h1 class="post-title m-b0" style="margin-bottom: 0px;"><a href="javascript:void(0);">{!! $resto->nama !!}</a></h1>
                    </div>
									...
									<div class="col-lg-4 col-md-4 col-sm-12 m-b30">
										<div class="icon-bx-wraper bx-style-1 p-a20 radius-sm br-col-w1">
											<div class="icon-content">
												...
												<p class="m-b0 op7">{{ $resto->jam_buka }}</p>
									...
									<div class="col-lg-4 col-md-4 col-sm-12 m-b30">
										<div class="icon-bx-wraper bx-style-1 p-a20 radius-sm br-col-w1">
											<div class="icon-content">
												...
												<p class="m-b0 op7">{{ $resto->telepon }}</p>
