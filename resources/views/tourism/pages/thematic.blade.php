...
@section('title', 'BOPLBF - Thematic Travel Plan')

@section('content')
	<!-- Content -->
	<div id="home" class="page-content bg-white">
		<div class="dlab-bnr-inr overlay-black-middle bg-pt" style="background-image:url({{asset('images/pulau_padar.jpg')}});">
            <div class="container">
                        ...
                        <div class="post card-container col-xl-4 col-lg-4 col-md-6 col-sm-12">
                            <div class="blog-post blog-grid blog-rounded blog-effect1">
                                <div class="dlab-post-media dlab-img-effect"> 
                                    <a href="{{url('tourism/package/'.$package->slug.'')}}"><img alt="" src="{{asset('uploads/TourismPackage/'.$package->id_relasi.'/'.$package->thumbnail.'')}}"></a> 
								                </div>
                                <div class="dlab-info p-a20 border-1">
                                  <div class="dlab-post-title ">
                                      <h5 class="post-title"><a href="{{url('tourism/package/'.$package->slug.'')}}">{{ $package->judul }}</a></h5>
                                  </div>
                                  Category : <br>
                                  @foreach($tags as $tag)
                                    @if($tag->id_relasi == $package->id_relasi)
                                  ...
                                  <div class="dlab-post-readmore"> 
                                    <a href="{{url('tourism/package/'.$package->slug.'')}}" title="READ MORE" rel="bookmark" class="site-button">READ MORE
