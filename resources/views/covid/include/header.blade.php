            ...
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    ...
                    <div class="logo-header mostion">
                        <a href="{{route('home')}}"><img src="images/logo-boplbf3.png" alt=""></a>
                    </div>
                    <!-- nav toggle button -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav"> 
                            <li class="has-mega-menu"> <a href="{{ route('tourism') }}#home">{{ __('header.home') }}</a></li>
                            <li class="has-mega-menu"> <a href="{{ route('tourism') }}#profile">{{ __('header.labuanBajo') }}</a></li>
                            <li class="has-mega-menu"> <a href="{{ route('tourism') }}#beyond">{{ __('header.beyond') }}</a></li>
                            <li class="has-mega-menu"> <a href="{{ route('tourism') }}#attraction">{{ __('header.attraction') }}</a></li>
                            <li class="has-mega-menu"> <a href="#Booking" class="site-button radius-no btnhover13">{{ __('header.booking') }}</a></li>
                        </ul>
