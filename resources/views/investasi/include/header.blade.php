            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" href="{{route('investasi')}}#home">{{ __('header.home') }}</a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" href="{{route('investasi')}}#invesment">{{ __('header.opportunity') }}</a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" href="{{route('investasi')}}#factsheet">{{ __('header.factsheet') }}</a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" href="{{route('investasi')}}#how_invest">{{ __('header.howTo') }}</a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" href="{{route('investasi')}}#business">{{ __('header.insider') }}</a>
                    </li>
                    !-->
                    <li class="nav-item">
