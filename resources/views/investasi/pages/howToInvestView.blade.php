...
@section('title', 'Industri & Investment How To Invest')
<style>
#tags {
  float: left;
	...
	<div id="home" class="page-content bg-white">
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">{{ __('investment.howTo') }}</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    ...
                    <div class="dlab-post-text">
                      @if(!empty($data->image))
                      <div class="row">
                        <img src="{{asset('uploads/InvestmentHTI/'.$data->image.'')}}" alt="" class="center">
                      </div>
                      @endif
                    </div>
                    <div class="dlab-post-text">
