...
@section('title', 'Industri & Investment Opportunity')
<style>
#tags {
  float: left;
	...
	<div id="home" class="page-content bg-white">
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">{{ __('investment.opportunity') }}</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container max-w900">
                ...
                <div class="blog-post blog-single">
                    <div class="dlab-post-title">
                        <h1 class="post-title m-b0" style="margin-bottom: 0px;"><a href="javascript:void(0);">{!! $data->judul !!}</a></h1>
                    </div>
                    ...
                    <div class="dlab-post-text">
                      @if(!empty($data->image))
                      <div class="row">
                        <img src="{{asset('uploads/InvestmentHN/'.$data->image.'')}}" alt="" class="center">
                      </div>
                      @endif
                    </div>
                    <div class="dlab-post-text">
