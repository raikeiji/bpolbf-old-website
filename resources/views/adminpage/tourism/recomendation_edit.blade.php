        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
               <section id="basic-tabs-components">
                    <form action="{{route('update.admin.t.recomendation')}}" method="post" enctype="multipart/form-data" id="form">
                        {{csrf_field()}}
                        <div class="card">
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-md-4">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" name="judul_id" placeholder="Judul Dalam Bahasa Indonesia" required>{{($data == null) ? "" : $data->judul_id}}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-4">
                                            <fieldset class="form-group">
                                                <label for="basicInput">Judul Dalam Bahasa Inggris <span class="text-red">*</span></label>
                                                <textarea type="text" class="form-control" name="judul_en" placeholder="Judul Dalam Bahasa Inggris" required>{{($data == null) ? "" : $data->judul_en}}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-4">
                                            <fieldset class="form-group">
                                                <label for="basicInput">Judul Dalam Bahasa China <span class="text-red">*</span></label>
                                                <textarea type="text" class="form-control" name="judul_cn" placeholder="Judul Dalam Bahasa China">{{($data == null) ? "" : $data->judul_cn}}</textarea>
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" >
                                            <fieldset class="form-group"style="width: 100%!important">
                                                ...
                                                <input type="text" class="form-control" name="link_url" placeholder="Masukkan Url" value="{{($data == null) ? "" : $data->link_url}}" required  style="width: 100%!important">
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
