                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.t.pyt')}}">Travel Plan Package</a>
                                    </li>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.t.pyt.store')}}" id="form_input"  method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                                ...
                                                <div class="form-group">
                                                    <select class="select2 form-control" multiple="multiple" name="destinasi[]" data-placeholder="Pilih Destinasi Terkait">
                                                        @if(!empty($labuans))
                                                            ...
                                                            @foreach($labuans as $labuan)
                                                                <option value="{{$labuan->id}}">{{$labuan->judul_id}}</option>
                                                            @endforeach
                                                            </optgroup>
                                                        @endif
                                                        ...
                                                        @if(!empty($beyonds))
                                                            ...
                                                            @foreach($beyonds as $beyond)
                                                                <option value="{{$beyond->id}}">{{$beyond->judul_id}}</option>
                                                            @endforeach
                                                            </optgroup>
                                                        @endif
                                                    </select>
