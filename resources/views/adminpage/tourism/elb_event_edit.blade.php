...
@section('custom_css')
    <link rel="stylesheet" type="text/css" href="{{asset('admin_page/app-assets/vendors/css/vendors.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin_page/app-assets/vendors/css/pickers/pickadate/pickadate.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin_page/app-assets/vendors/css/pickers/daterange/daterangepicker.css')}}">
    <style>
        .text-red {
            color: red !important;
        }
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.t.elb.destinasi')}}">Enchanting Labuan Bajo Destinasi</a>
                                    </li>
                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.t.elb.event.update')}}"  method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul_id" value="{{$data->judul_id}}" required id="basicInput" placeholder="Masukkan Judul">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                                ...
                                                <select class="select2 form-control" name="alamat" id="alamat">
                                                    ...
                                                    @if(!empty($destinations))
                                                        ...
                                                        @foreach($destinations as $destination)
                                                            <option value="{{$destination->id}}" data-tipe="tourism_tm_destination"><strong>{{$destination->judul_id}}</strong> - {{$destination->alamat}}</option>
                                                        @endforeach
                                                        </optgroup>
                                                    @endif
                                                    @if(!empty($productions))
                                                        ...
                                                        @foreach($productions as $production)
                                                            <option value="{{$production->id}}" data-tipe="tourism_tm_rumah_produksi"><strong>{{$production->nama}}</strong> - {{$production->alamat}}</option>
                                                        @endforeach
                                                        </optgroup>
                                                    @endif
                                                    @if(!empty($restos))
                                                        ...
                                                        @foreach($restos as $resto)
                                                            <option value="{{$resto->id}}" data-tipe="tourism_tm_resto"><strong>{{$resto->nama}}</strong> - {{$resto->alamat}}</option>
                                                        @endforeach
                                                        </optgroup>
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="penyelenggara" id="basicInput" placeholder="Masukkan Penyelenggara" value="{{$data->penyelenggara}}">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                <label for="basicInput">URL Tiket</label>
                                                <input type="text" class="form-control" name="url_tiket" id="basicInput" placeholder="Masukkan URL Pembelian Tiket" value="{{$data->url_tiket}}">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                @foreach($galleries as $gallery)
                                                    <tr id="gallery_{{$gallery->id}}">
                                                        <th><img src="{{asset('uploads/TourismEvent/ELB/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" alt="" width="150px"></th>
                                                        <th>
...
@section('script')
    <script type="text/javascript">
        $('.timeseconds').daterangepicker({
            ...
            startDate: new Date('{{$data->waktu_event}}'),
            endDate: new Date('{{$data->waktu_event_end}}')
        });
        ...
        $uploadCrop.croppie('bind', {
            url: "{{asset('uploads/TourismEvent/ELB/'.$data->id.'/'.$data->thumbnail.'')}}",
            zoom: 0
        }).then(function(){
        ...
        $("#alamat").val('{{$data->id_relasi}}').trigger('change');
        $("#jenis_event").val('{{$data->status_event}}').trigger('change');
