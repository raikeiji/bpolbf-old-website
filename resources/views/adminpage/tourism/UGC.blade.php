                                            ...
                                            <table class="table table-bordered table-hover zero-configuration">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit" onClick="popModalEdit('{{ $data->id }}','{{ $data->hashtag }}')"><i class="bx bxs-edit-alt"></i></button></button>
                                                    </td>
                                                </tr>
