                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.t.culinary')}}">Culinary</a>
                                    </li>
                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form action="{{route('admin.t.culinary.update')}}" id="form_input" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <select id="toko" name="toko[]" id="Select" multiple="multiple" class="select2 form-control" data-placeholder="Pilih Toko">
                                                    @foreach($toko as $s => $value)
                                                        {{$status = 0}}
                                                        @foreach($relasiToko as $rs => $v)
                                                            @if($value->id == $v->id_resto)
                                                                {{$status = 1}}
                                                            @endif
                                                        @endforeach
                                                        @if($status == 1)
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="URL" id="url"  placeholder="Masukkan URL Video" value="{{$data->video_url}}">
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                @foreach($galleries as $gallery)
                                                    <tr id="gallery_{{$gallery->id}}">
                                                        <th><img src="{{asset('uploads/TourismCulinary/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" alt="" width="150px"></th>
                                                        <th>
...
$uploadCrop.croppie('bind', {
    url: "{{asset('uploads/TourismCulinary'.$data->id.'/'.$data->thumbnail.'')}}",
    zoom: 0
}).then(function(){
