                ...
                <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.t.elb.destinasi.update')}}"  method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="url_repulso" id="basicInput" placeholder="Masukkan URL Video" value="{{$data->url_repuso}}">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                @foreach($galleries as $gallery)
                                                    <tr id="gallery_{{$gallery->id}}">
                                                        <th><img src="{{asset('uploads/TourismDestinasi/ELB/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" alt="" width="150px"></th>
                                                        <th>
...
@section('script')
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "{{asset('uploads/TourismDestinasi/ELB/'.$data->id.'/'.$data->thumbnail.'')}}",
            zoom: 0
        }).then(function(){
