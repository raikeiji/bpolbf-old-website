                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.t.elb')}}">Enchanting Labuan Bajo</a>
                                    </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form Enchanting Labuan Bajo</h4>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-md-12">
                                        <a href="{{route('admin.t.elb')}}" class="btn btn-primary float-right" style="margin-top: 25px;">Simpan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
