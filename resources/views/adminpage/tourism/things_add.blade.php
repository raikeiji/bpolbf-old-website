...
@section('title')
CMS Tourism - Tourism Things To Do, See And Buy
@endsection
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Tourism Things To Do, See And Buy</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.index')}}"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{route('admin.t.things')}}">Tourism Things To Do, See And Buy</a>
                                    </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form Tourism Things To Do, See And Buy</h4>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                       ...
                                       <div class="row">
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <label for="basicInput">Jenis Kegiatan</label>
                                ...
                                <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                    ...
                                    <div class="col-sm-12 col-lg-12 col-md-12">
                                        <a href="{{route('admin.t.things')}}" class="btn btn-primary float-right" style="margin-top: 25px;">Simpan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
