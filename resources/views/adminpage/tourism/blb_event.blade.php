                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('admin.t.blb.event.add')}}" class="btn btn-success round glow">
                                                ...
                                                @foreach($data as $d)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{route('admin.t.blb.event.edit',$d->id)}}"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
@section('script')
    <script>
        ...
        function submitDelete(){
            ...
            $.post( "{{route('admin.t.blb.event.delete')}}", { "_token": "{{ csrf_token() }}", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="{{route('admin.t.blb.event')}}";
                        }, 1000);
                    } else {
