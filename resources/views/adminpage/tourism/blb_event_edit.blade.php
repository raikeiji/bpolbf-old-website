                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form Event Beyond Labuan Bajo</h4>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.t.blb.event.update')}}"  method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            ...
                                            <table class="table table-bordered text-center" id="data-image">
                                                ...
                                                @foreach($galleries as $gallery)
                                                    <tr id="gallery_{{$gallery->id}}">
                                                        <th><img src="{{asset('uploads/TourismEvent/BLB/'.$gallery->id_relasi.'/gallery/'.$gallery->file_img.'')}}" alt="" width="150px"></th>
                                                        <th>
...
@section('script')
    <script type="text/javascript">
        ...
        $uploadCrop.croppie('bind', {
            url: "{{asset('uploads/TourismEvent/BLB/'.$data->id.'/'.$data->thumbnail.'')}}",
            zoom: 0
        }).then(function(){
