                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('admin.t.rumah.add')}}" class="btn btn-success round glow">
                                                ...
                                                @foreach($data as $d)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{route('admin.t.rumah.edit',$d->id)}}"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
@section('script')
    <script>
        ...
        function submitDelete(){
            ...
            $.post( "{{route('admin.t.rumah.delete')}}", { "_token": "{{ csrf_token() }}", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
