...
@section('title')
CMS Tourism - Things To Do, See And Buy
@endsection
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Things To Do, See And Buy
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('admin.t.things.add')}}" class="btn btn-success round glow">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover zero-configuration">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td class="text-center"><div class="badge badge-primary">SEE</div></td>
                                                        <td>
                                                           Manta Ray
                                                        </td>
