                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('admin.lbfta.faq.add')}}" class="btn btn-success round glow">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($data as $d)
                                                        <tr>
                                                            <td>{{$i}}</td>
                                                            <td>{!! $d->judul_id !!}</td>
                                                            <td>{!! $d->deskripsi_id !!}</td>
                                                            <td>{{$d->category}}</td>
                                                            <td class="text-center">
                                                                <a href="{{route('admin.lbfta.faq.edit',$d->id)}}"><button type="button" class="btn btn-icon rounded-circle btn-primary glow" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
        ...
        function popModalDelete(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type:"POST",
                        url : "{{route('admin.lbfta.faq.delete')}}",
                        data: { 
                            "_token": "{{ csrf_token() }}",
                            "id": id,
                        },
