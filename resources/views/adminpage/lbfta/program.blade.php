                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <!--
                                    <a href="{{route('admin.lbfta.program.add')}}" class="btn btn-success round glow">
                                                    ...
                                                    @foreach($data as $d)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{route('admin.lbfta.program.edit',$d->id)}}"><button type="button" class="btn btn-icon rounded-circle btn-primary glow" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
        ...
        function popModalDelete(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type:"POST",
                        url : "{{route('admin.lbfta.program.delete')}}",
                        data: { 
                            "_token": "{{ csrf_token() }}",
                            "id": id,
                        },
