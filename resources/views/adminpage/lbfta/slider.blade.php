                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('admin.lbfta.slider.add')}}" class="btn btn-success round glow">
                                                ...
                                                <tbody>
                                                    @foreach($slider as $s)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{route('admin.lbfta.slider.edit',$s->id)}}"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
@section('script')
    <script>
        ...
        function submitDelete(){
            ...
            $.post( "{{route('admin.lbfta.slider.delete')}}", { "_token": "{{ csrf_token() }}", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="{{route('admin.lbfta.slider')}}";
                        }, 1000);
                    } else {
        ...
        function submitActive(id,nama) {
            $(".cover-spin").fadeIn(500)
            up_nama = nama
            $.post( "{{route('admin.lbfta.slider.active')}}", { "_token": "{{ csrf_token() }}", "id": id })
                .done(function( res ) {
                    if (res==1){
        ...
        function showImg(id, file){
            ...
            $('#imgContainer').attr('src', "{{asset('uploads/SliderProfile')}}/"+file+"");
