                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.lbfta.about')}}">LBFTA About Profile</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.lbfta.about.update')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
