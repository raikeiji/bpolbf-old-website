               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.lbfta.org.update')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            ...
                                            <img id="imgContainer" style="width: 300px" src="{{asset('uploads/ProfileOrg/'.$data->image.'')}}">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12" style="margin-top:20px">
                                            ...
                                            <img id="imgContainer2" style="width: 300px" src="{{asset('uploads/ProfileOrg/'.$data->image_2.'')}}">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
