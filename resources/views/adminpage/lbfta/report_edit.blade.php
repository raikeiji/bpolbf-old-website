...
<div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.lbfta.report')}}">Edit Report</a>
                                    </li>
            ...
            <div class="content-body">
                <form action="{{route('admin.lbfta.report.update')}}" id="form_input"  method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        ...
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="basicInput" name="file_url" placeholder="Masukkan Sumber" value="{{$data->file_url}}">
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-md-12">
                                            <fieldset class="form-group">
