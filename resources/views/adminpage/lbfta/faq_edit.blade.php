               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.lbfta.faq.update')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <textarea lass="form-control" id="editor1" name="judul_id" rows="3">{{$data->judul_id}}</textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Jawaban</label>
                                                        <textarea lass="form-control" id="editor2" name="deskripsi_id" rows="3">{{$data->deskripsi_id}}</textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Pertanyaan</label>
                                                        <textarea lass="form-control" id="editor3" name="judul_en" rows="3">{{$data->judul_en}}</textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Jawaban</label>
                                                        <textarea lass="form-control" id="editor4" name="deskripsi_en" rows="3">{{$data->deskripsi_en}}</textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="cn" aria-labelledby="cn-tab" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Pertanyaan</label>
                                                        <textarea lass="form-control" id="editor5" name="judul_cn" rows="3">{{$data->judul_cn}}</textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="basicInput">Jawaban</label>
                                                        <textarea lass="form-control" id="editor6" name="deskripsi_cn" rows="3">{{$data->deskripsi_cn}}</textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
