...
<div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.lbfta.officials')}}">Officials</a>
                                    </li>
            ...
            <div class="content-body">
                <form action="{{route('admin.lbfta.officials.store')}}" id="form_input"  method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
