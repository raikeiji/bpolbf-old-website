            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">LBFTA Achievement</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.index')}}"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{route('admin.lbfta.achievement')}}">Achievement</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="id" aria-labelledby="id-tab" role="tabpanel">
                                       <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    <label for="basicInput">Angka Pencapaian</label>
                                                    <input type="number" class="form-control" id="basicInput" placeholder="Masukkan Angka Pencapaian">
                                                </fieldset>
                                            </div>
                                        </div>
