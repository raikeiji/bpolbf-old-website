                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.inv.benefit_resiko')}}">Benefit & Resiko Factsheet and Data</a>
                                    </li>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form action="{{route('admin.inv.benefit_resiko.update')}}" id="form_input"  method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="imgContainer" style="width: 100%;" src="{{asset('uploads/InvestmentBenefit/'.$data->image.'')}}">
                                </div>
