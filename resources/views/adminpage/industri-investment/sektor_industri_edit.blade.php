                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.inv.sektor_industri')}}">Ragam Sektor Industri Factsheet and Data</a>
                                    </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h4>Form Ragam Sektor Industri</h4>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.inv.sektor_industri.update')}}" id="form_input"  method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-12">
                                                            <fieldset class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="basicInput" name="judul_id" placeholder="Masukkan Judul" value="{{$data->judul_id}}">
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <fieldset class="form-group">
                                                                <label for="basicInput">Deskripsi</label>
                                                                <textarea data-length=200 class="form-control" maxlength="200" name="deskripsi_id" id="textarea-counter char-textarea" rows="3" placeholder="Deskripsi">{{$data->deskripsi_id}}</textarea>
                                                            </fieldset>
                                            ...
                                            <div class="tab-pane" id="us" aria-labelledby="en-tab" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <fieldset class="form-group">
                                                            <label for="basicInput">Judul</label>
                                                            <input type="text" class="form-control" id="basicInput" name="judul_en" placeholder="Masukkan Judul" value="{{$data->judul_en}}">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <fieldset class="form-group">
                                                            <label for="basicInput">Deskripsi</label>
                                                            <textarea data-length=200 class="form-control char-textarea" name="deskripsi_en" maxlength="200" id="textarea-counter" rows="3" placeholder="Deskripsi">{{$data->deskripsi_en}}</textarea>
                                                        </fieldset>
                                                        <small class="counter-value float-right"><span class="char-count">0</span> / 200 </small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <button type="button" class="btn btn-outline-primary mr-1 mb-1" data-toggle="modal" data-target="#modal_imgShow">{{$data->image}}</button>
                                            </fieldset>
                                            <fieldset class="form-group">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="imgContainer" style="width: 100%;" src="{{asset('uploads/InvestmentSektor/'.$data->image.'')}}">
                                </div>
