                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.inv.how_to_invest')}}">Industri & Investment - How To Invest</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
               ...
               <section id="basic-tabs-components">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{route('admin.inv.how_to_invest.update')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row" style="margin-top: 25px;padding-left: 10px;">
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            ...
                                            <img id="imgContainer" style="width: 300px" src="{{asset('uploads/InvestmentHTI/'.$data->image.'')}}">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
