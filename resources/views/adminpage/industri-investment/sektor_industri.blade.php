                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('admin.inv.sektor_industri.add')}}" class="btn btn-success round glow">
                                            ...
                                            <p hidden>{{$i = 1}}</p>
                                                ...
                                                @foreach($data as $k)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{route('admin.inv.sektor_industri.edit',$k->id)}}"><button type="button" class="btn btn-icon rounded-circle btn-primary glow mr-1 mb-1" title="Edit"><i class="bx bxs-edit-alt"></i></button></a>
...
@if($status ==  1)
        ...
        function submitDelete(){
            ...
            $.post( "{{route('admin.inv.sektor_industri.delete')}}", { "_token": "{{ csrf_token() }}", "id": idTarget })
                .done(function( res ) {
                    if (res==1){
                        ...
                        setTimeout(function(){
                            ...
                            window.location.href="{{route('admin.inv.sektor_industri')}}";
                        }, 1000);
                    } else {
        ...
        function showImg(id, file){
            ...
            $('#imgContainer').attr('src', "{{asset('uploads/InvestmentSektor')}}/"+file+"");
