      ...
      <section class="content" id="BOP-Program">
        <div class="container">
          <div class="text-center mb-5">
            <img class="mr-3" src="{{asset('assets/icons/icon-bop-kukp.svg')}}" alt="icon" class="mx-auto">
            <h2 class="mb-4">{!! $data->judul !!}</h2>
          </div>
      
          <div class="row py-4 program-list">
            @foreach($sub_program as $f)
              <div class="col col-md-6 mb-5">
                <div class="program-item">
                  <div class="media">
                    <img class="mr-3" src="{{asset('assets/icons/icon-bop-kukp.svg')}}" alt="icon">
                    <div class="media-body">
                      <h4 class="mt-0 mb-2 program-title no-line">{!! $f->judul !!}</h4>
